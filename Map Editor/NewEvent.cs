...
namespace Map_Editor
{
    public partial class NewEvent : Form
    {
        ...
        public NewEvent(Microsoft.Xna.Framework.Vector2 currentTile,Event category)
        {
            InitializeComponent();
        ...
        public NewEvent(Event category)
        {
            InitializeComponent();
            tmpEventCategory = category;
            this.CancelButton = button2;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                tmpEvent.variable = textBox6.Text;
                tmpEvent.value = textBox5.Text;
